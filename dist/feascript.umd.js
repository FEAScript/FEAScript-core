function _loadWasmModule(e,t,n){for(var o=t.length,r="="==t[o-2]?2:"="==t[o-1]?1:0,i=new Uint8Array(3*o/4-r),s="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",a=new Uint8Array(130),l=0;l<64;l++)a[s.charCodeAt(l)]=l;for(var c=0,u=0;c<o;c+=4){var d=a[t.charCodeAt(c+1)],f=a[t.charCodeAt(c+2)];i[u++]=a[t.charCodeAt(c)]<<2|d>>4,i[u++]=(15&d)<<4|f>>2,i[u++]=(3&f)<<6|63&a[t.charCodeAt(c+3)]}if(n&&!e)return WebAssembly.instantiate(i,n);if(n||e){var m=new WebAssembly.Module(i);return n?new WebAssembly.Instance(m,n):m}return WebAssembly.compile(i)}!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports):"function"==typeof define&&define.amd?define(["exports"],t):t((e="undefined"!=typeof globalThis?globalThis:e||self).FEAScript={})}(this,(function(e){"use strict";function t(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}
/**
	* @license Apache-2.0
	*
	...
	*/var n,o,r,i,s,a,l,c,u,d,f,m,h,p,g,y,b,v,E,C,w,D,M,F,A,$,x,k,N,O,P,S,V,I,T,X,R,j,Y,B,W,q,G,_,L,K,U,J,H,z,Z,Q,ee,te,ne,oe,re,ie,se,ae,le,ce,ue,de;function fe(){if(i)return r;i=1;var e=function(){if(o)return n;o=1;var e="function"==typeof Object.defineProperty?Object.defineProperty:null;return n=e}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2021 The Stdlib Authors.
...
/**
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/function ye(){if($)return A;$=1;var e=function(){if(F)return M;F=1;var e=/%(?:([1-9]\d*)\$)?([0 +\-#]*)(\*|\d+)?(?:(\.)(\*|\d+)?)?[hlL]?([%A-Za-z])/g;function t(e){var t={mapping:e[1]?parseInt(e[1],10):void 0,flags:e[2],width:e[3],precision:e[5],specifier:e[6]};return"."===e[4]&&void 0===e[5]&&(t.precision="1"),t}return M=function(n){var o,r,i,s;for(r=[],s=0,i=e.exec(n);i;)(o=n.slice(s,e.lastIndex-i[0].length)).length&&r.push(o),"%"===i[6]?r.push("%"):r.push(t(i)),s=e.lastIndex,i=e.exec(n);return(o=n.slice(s)).length&&r.push(o),r}}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2022 The Stdlib Authors.
...
/**
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/function be(){if(O)return N;O=1;var e=function(){if(D)return w;D=1;var e=ge();return w=e}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2022 The Stdlib Authors.
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/(),t=ye(),n=k?x:(k=1,x=function(e){return"string"==typeof e});return N=function o(r){var i,s;if(!n(r))throw new TypeError(o("invalid argument. First argument must be a string. Value: `%s`.",r));for(i=[t(r)],s=1;s<arguments.length;s++)i.push(arguments[s]);return e.apply(null,i)},N}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2022 The Stdlib Authors.
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/function ve(){if(I)return V;I=1;var e=function(){if(S)return P;S=1;var e=be();return P=e}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2018 The Stdlib Authors.
...
/**
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/function we(){if(_)return G;_=1;var e=q?W:(q=1,W=function(e,t){return t>0?0:(1-e)*t});return G=e}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2018 The Stdlib Authors.
...
/**
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/var $e,xe,ke,Ne,Oe,Pe,Se=function(){if(de)return ue;de=1;var e=Ce(),t=function(){if(ce)return le;ce=1;var e=we(),t=Ae();return le=function(n,o,r){var i=e(n,r);return t(n,o,r,i)}}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2020 The Stdlib Authors.
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/();return e(t,"ndarray",Ae()),ue=t}(),Ve=t(Se);function Ie(){if(xe)return $e;xe=1;return $e=function(e,t,n,o,r,i,s){var a,l,c,u,d;if(a=0,e<=0)return a;if(l=o,c=s,1===n&&1===i){if((u=e%5)>0)for(d=0;d<u;d++)a+=t[l]*r[c],l+=1,c+=1;if(e<5)return a;for(d=u;d<e;d+=5)a+=t[l]*r[c]+t[l+1]*r[c+1]+t[l+2]*r[c+2]+t[l+3]*r[c+3]+t[l+4]*r[c+4],l+=5,c+=5;return a}for(d=0;d<e;d++)a+=t[l]*r[c],l+=n,c+=i;return a}}
/**
	* @license Apache-2.0
	*
	...
	* See the License for the specific language governing permissions and
	* limitations under the License.
	*/var Te,Xe,Re,je,Ye,Be,We=function(){if(Pe)return Oe;Pe=1;var e=Ce(),t=function(){if(Ne)return ke;Ne=1;var e=we(),t=Ie();return ke=function(n,o,r,i,s){var a,l;return n<=0?0:(a=e(n,r),l=e(n,s),t(n,o,r,a,i,s,l))}}
/**
	* @license Apache-2.0
	*
	* Copyright (c) 2019 The Stdlib Authors.
