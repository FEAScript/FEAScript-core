...
*/var t,n,o,i,r,s,a,l,c,u,d,m,f,h,p,g,y,b,v,E,C,w,D,M,F,$,A,x,k,N,P,O,V,S,I,X,T,R,j,Y,B,q,W,G,_,L,K,J,H,U,z,Z,Q,ee,te,ne,oe,ie,re,se,ae,le,ce,ue;function de(){if(i)return o;i=1;var e=function(){if(n)return t;n=1;var e="function"==typeof Object.defineProperty?Object.defineProperty:null;return t=e}
/**
* @license Apache-2.0
*
* Copyright (c) 2021 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=h?f:(h=1,f=function(e){return"string"==typeof e}),n=fe(),o=function(){if(g)return p;g=1;var e=Math.abs,t=String.prototype.toLowerCase,n=String.prototype.toUpperCase,o=String.prototype.replace,i=/e\+(\d)$/,r=/e-(\d)$/,s=/^(\d+)$/,a=/^(\d+)e/,l=/\.0$/,c=/\.0*e/,u=/(\..*[^0])0*e/;return p=function(d,m){var f,h;switch(m.specifier){case"e":case"E":h=d.toExponential(m.precision);break;case"f":case"F":h=d.toFixed(m.precision);break;case"g":case"G":e(d)<1e-4?((f=m.precision)>0&&(f-=1),h=d.toExponential(f)):h=d.toPrecision(m.precision),m.alternate||(h=o.call(h,u,"$1e"),h=o.call(h,c,"e"),h=o.call(h,l,""));break;default:throw new Error("invalid double notation. Value: "+m.specifier)}return h=o.call(h,i,"e+0$1"),h=o.call(h,r,"e-0$1"),m.alternate&&(h=o.call(h,s,"$1."),h=o.call(h,a,"$1.e")),d>=0&&m.sign&&(h=m.sign+h),m.specifier===n.call(m.specifier)?n.call(h):t.call(h)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2022 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),r=he(),s=String.fromCharCode,a=Array.isArray;function l(e){return e!=e}function c(e){var t={};return t.specifier=e.specifier,t.precision=void 0===e.precision?1:e.precision,t.width=e.width,t.flags=e.flags||"",t.mapping=e.mapping,t}return v=function(u){var d,m,f,h,p,g,y,b,v,E;if(!a(u))throw new TypeError("invalid argument. First argument must be an array. Value: `"+u+"`.");for(g="",y=1,v=0;v<u.length;v++)if(f=u[v],t(f))g+=f;else{if(d=void 0!==f.precision,!(f=c(f)).specifier)throw new TypeError("invalid argument. Token is missing `specifier` property. Index: `"+v+"`. Value: `"+f+"`.");for(f.mapping&&(y=f.mapping),m=f.flags,E=0;E<m.length;E++)switch(h=m.charAt(E)){case" ":f.sign=" ";break;case"+":f.sign="+";break;case"-":f.padRight=!0,f.padZeros=!1;break;case"0":f.padZeros=m.indexOf("-")<0;break;case"#":f.alternate=!0;break;default:throw new Error("invalid flag: "+h)}if("*"===f.width){if(f.width=parseInt(arguments[y],10),y+=1,l(f.width))throw new TypeError("the argument for * width at position "+y+" is not a number. Value: `"+f.width+"`.");f.width<0&&(f.padRight=!0,f.width=-f.width)}if(d&&"*"===f.precision){if(f.precision=parseInt(arguments[y],10),y+=1,l(f.precision))throw new TypeError("the argument for * precision at position "+y+" is not a number. Value: `"+f.precision+"`.");f.precision<0&&(f.precision=1,d=!1)}switch(f.arg=arguments[y],f.specifier){case"b":case"o":case"x":case"X":case"d":case"i":case"u":d&&(f.padZeros=!1),f.arg=e(f);break;case"s":f.maxWidth=d?f.precision:-1,f.arg=String(f.arg);break;case"c":if(!l(f.arg)){if((p=parseInt(f.arg,10))<0||p>127)throw new Error("invalid character code. Value: "+f.arg);f.arg=l(p)?String(f.arg):s(p)}break;case"e":case"E":case"f":case"F":case"g":case"G":if(d||(f.precision=6),b=parseFloat(f.arg),!isFinite(b)){if(!n(f.arg))throw new Error("invalid floating-point number. Value: "+g);b=f.arg,f.padZeros=!1}f.arg=o(b,f);break;default:throw new Error("invalid specifier: "+f.specifier)}f.maxWidth>=0&&f.arg.length>f.maxWidth&&(f.arg=f.arg.substring(0,f.maxWidth)),f.padZeros?f.arg=r(f.arg,f.width||f.precision,f.padRight):f.width&&(f.arg=i(f.arg,f.width,f.padRight)),g+=f.arg||"",y+=1}return g},v}
/**
* @license Apache-2.0
*
* Copyright (c) 2022 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function be(){if(S)return V;S=1;var e=function(){if(O)return P;O=1;var e=ye();return P=e}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/(),t=Object.prototype,n=t.toString,o=t.__defineGetter__,i=t.__defineSetter__,r=t.__lookupGetter__,s=t.__lookupSetter__;return V=function(a,l,c){var u,d,m,f;if("object"!=typeof a||null===a||"[object Array]"===n.call(a))throw new TypeError(e("invalid argument. First argument must be an object. Value: `%s`.",a));if("object"!=typeof c||null===c||"[object Array]"===n.call(c))throw new TypeError(e("invalid argument. Property descriptor must be an object. Value: `%s`.",c));if((d="value"in c)&&(r.call(a,l)||s.call(a,l)?(u=a.__proto__,a.__proto__=t,delete a[l],a[l]=c.value,a.__proto__=u):a[l]=c.value),m="get"in c,f="set"in c,d&&(m||f))throw new Error("invalid argument. Cannot specify one or more accessors and a value or writable attribute in the property descriptor.");return m&&o&&o.call(a,l,c.get),f&&i&&i.call(a,l,c.set),a}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ve(){if(R)return T;R=1;var e=function(){if(X)return I;X=1;var e,t=de(),n=me(),o=be();return e=t()?n:o,I=e}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function we(){if(U)return H;U=1;var e=J?K:(J=1,K=function(e){return Math.abs(e)});return H=e}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Fe(){if(se)return re;se=1;var e=L?_:(L=1,_=17976931348623157e292),t=we(),n=De(),o=Me(),i=44989137945431964e145,r=11113793747425387e-178;return re=function(s,a,l,c){var u,d,m,f,h,p,g,y,b,v,E;if(s<=0)return 0;for(v=c,u=!0,d=0,m=0,f=0,h=0,y=1,E=0;E<s;E++)(b=t(a[v]))>1997919072202235e131?(m+=n(b*r),u=!1):b<14916681462400413e-170?u&&(h+=n(b*i)):f+=b*b,v+=l;return m>0?((f>0||f>e||f!=f)&&(m+=f*r*r),y=1/r,d=m):h>0?f>0||f>e||f!=f?(f=o(f),(h=o(h)/i)>f?(g=f,p=h):(g=h,p=f),y=1,d=p*p*(1+n(g/p))):(y=1/i,d=h):(y=1,d=f),o(d)*y}}
/**
* @license Apache-2.0
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var $e,Ae,xe,ke,Ne,Pe,Oe=function(){if(ue)return ce;ue=1;var e=Ee(),t=function(){if(le)return ae;le=1;var e=Ce(),t=Fe();return ae=function(n,o,i){var r=e(n,i);return t(n,o,i,r)}}
/**
* @license Apache-2.0
*
* Copyright (c) 2020 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ie,Xe,Te,Re,je,Ye,Be=function(){if(Pe)return Ne;Pe=1;var e=Ee(),t=function(){if(ke)return xe;ke=1;var e=Ce(),t=Se();return xe=function(n,o,i,r,s){var a,l;return n<=0?0:(a=e(n,i),l=e(n,s),t(n,o,i,a,r,s,l))}}
/**
* @license Apache-2.0
*
* Copyright (c) 2019 The Stdlib Authors.
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ge,_e,Le,Ke,Je,He,Ue=function(){if(Ye)return je;Ye=1;var e=Ee(),t=function(){if(Re)return Te;Re=1;var e=Ce(),t=We();return Te=function(n,o,i,r,s){var a,l;return n<=0?r:(a=e(n,i),l=e(n,s),t(n,o,i,a,r,s,l))}}
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
